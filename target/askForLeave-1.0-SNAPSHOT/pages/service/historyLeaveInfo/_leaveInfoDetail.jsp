        ...
        <div style="padding: 10px">
            <form class="layui-form layui-form-pane" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="leaveComment" class="layui-input" name="title" disabled autocomplete="off" >
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="endLeaveComment" class="layui-input" name="title" disabled autocomplete="off" >
                    </div>
                </div>
