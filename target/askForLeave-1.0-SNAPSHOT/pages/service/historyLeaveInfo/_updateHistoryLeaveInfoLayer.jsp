    ...
    <body>
        <div style="padding: 10px">
            <form class="layui-form layui-form-pane" action="">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width:200px">销假日期</label>
                    <div class="layui-input-inline" style="width:350px">
                        <input type="text" class="layui-input"
                               autocomplete="off" lay-verify="required"
                               name="end_date"
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width:200px">销假备注</label>
                    <div class="layui-input-inline" style="width:350px">
                        <textarea placeholder="" name="end_leave_remark"
                                  id="end_leave_remark"
                                  autocomplete="off"
                                  class="layui-textarea"></textarea>
                    </div>
                ...
                <button type="submit" class="layui-btn" style="display:none"
                        id="updateHistoryInfoSubmit" lay-submit lay-filter="updateHistoryInfoSubmit"></button>
                <button type="reset" class="layui-btn" style="display:none"
                        id="updateHistoryInfoReset" lay-submit lay-filter="updateHistoryInfoReset"></button>
        ...
        <script type="text/javascript">
            layui.use(['laydate','form','common','table'], function() {
                ...
                form.on('submit(updateHistoryInfoSubmit)', function(data){
                    ...
                    const end_date = sourceData.end_date;
                    const end_leave_remark = sourceData.end_leave_remark;
                    //获取当前页码
                    ...
                    parent.layer.confirm('您的操作行为将写入日志，确定修改？', {
                        ...
                        $.ajax({
                            type : 'POST',
                            url : 'askForLeaveServlet?action=updateHistoryInfo',
                            data : {
                            ...
                            success : function(data) {
                                if(data.code==1){
                                    ...
                                    //重载表格
                                    parent.layui.table.reload('historyInfo', {
