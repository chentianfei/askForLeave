...
<div class="layui-layout layui-layout-admin">
                ...
                <div class="layui-row">
                    <div class="layui-col-md12">
                        <div class="layui-card">
                            <div class="layui-card-header layui-bg-blue">以往到期未销假人员信息</div>
                                ...
                                <form class="layui-form layui-form-pane">
                                    ...
                                    <div class="layui-form-item" style="padding-left: 70%">
                                        <div class="layui-input-block">
                                            <button type="submit" class="layui-btn" lay-submit lay-filter="currentEOLInfo_before">查询</button>
                        ...
                        <div class="layui-col-md12">
                            <div class="layui-card">
                                ...
                                <div class="layui-card-body">
                                    ...
                                    <%--所有到岗未销假人员表格--%>
                                    <table class="layui-hide" id="currentEOLInfo_before"
                                           lay-filter="currentEOLInfo_before"></table>
    ...
    <input  type="hidden" class="layui-input"
            ...
            style="display:none"
            id="table_elem_name"  value="currentEOLInfo_before"/>
...
<%--所有到假未到岗人员表格内部工具栏--%>
<script type="text/html" id="toolbar_currentEOLInfo_before">
...
<script>
    layui.use(['table', 'upload', 'laydate',  'form', 'layer','common'], function () {
        ...
        var currentEOLInfo_before_table = table.render({
            ...
            ,toolbar: '#toolbar'
            ,defaultToolbar: []
            ,title: '以往到期未销假人员信息表'+new Date().getTime()
            ,request: {
        ...
        //行工具栏事件
        table.on('tool(currentEOLInfo_before)', function (obj) {
            var data = obj.data;
                                ...
                                $.ajax({
                                    ...
                                    success: function (result) {
                                        if(result.code == 1){
                                            ...
                                            //重载表格
                                            table.reload('currentEOLInfo_before', {
                                                url: 'askForLeaveServlet?action=queryAllCurrentEOLPerson'
                                                ,page: {
        ...
        table.on('toolbar(currentEOLInfo_before)', function(obj){
            ...
            switch(obj.event){
                ...
                //导出数据
                case 'export':
                    table.exportFile(currentEOLInfo_before.config.id, exportData, 'xls');
                    break;
            };
        });

        //监听查询区域的提交按钮事件
        form.on('submit(currentEOLInfo_before)',function (data) {
            //获取当前页码
            var currentPage = $(".layui-laypage-skip .layui-input").val();
            //获取数据
            ...
            table.reload('currentEOLInfo_before', {
                url: 'askForLeaveServlet?action=querySomeAllCurrentEOLPerson'
                ,where: {
                    //设定异步数据接口的额外参数
                    //人员信息
                    name : name,
