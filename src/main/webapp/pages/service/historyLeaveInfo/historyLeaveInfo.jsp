...
<html>
                                        ...
                                        <div class="layui-card-body">
                                            ...
                                            <form class="layui-form layui-form-pane">
                                                ...
                                                <div class="layui-form-item">
                                                    ...
                                                    <div class="layui-inline">
                                                        <label class="layui-form-label"
                                                               style="width: 145px">实际到岗时间</label>
                                                        <div class="layui-inline"  id="end_date">
                                                            <div class="layui-input-inline" style="width: 130px">
                                                                <input type="text" autocomplete="off" id="end_date_min"
                                                                       name="end_date_min"
                                                                       class="layui-input" placeholder="开始日期">
                                                            </div>
                                                            <div class="layui-form-mid">至</div>
                                                            <div class="layui-input-inline" style="width: 130px">
                                                                <input type="text" autocomplete="off" id="end_date_max"
                                                                       name="end_date_max"
                                                                       class="layui-input" placeholder="结束日期">
                                                            </div>
                                                        </div>
    ...
    <script>
        layui.use(['table','upload','laydate','element','form', 'layer', 'util','common'], function(){
            ...
            laydate.render({
                elem: '#end_date'
                ,range: ['#end_date_min', '#end_date_max']
            });
            ...
            //表格数据初始化
            var historyInfoQueyr_table =table.render({
                elem: '#historyInfo'
                ,url:'askForLeaveServlet?action=queryALLHistoryInfo'
                ,toolbar: '#toolbar'
                ,defaultToolbar: []
                ,title: '历史请销假信息表'+new Date().getTime()
                ,request: {
            ...
            table.on('toolbar(historyInfo)', function(obj){
                ...
                switch(obj.event){
                    ...
                    //导出数据
                    case 'export':
                        table.exportFile(historyInfoQueyr_table.config.id, exportData, 'xls');
                        break;
                };
            });
            ...
            form.on('submit(historyInfoQuery)',function (data) {
                ...
                const end_date_max = sourceData.end_date_max;
                const end_date_min = sourceData.end_date_min;
