...
<div style="padding: 10px">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <button type="submit" class="layui-btn" style="display:none"
                id="updateLeaderInfoSubmit" lay-submit
                lay-filter="updateLeaderInfoSubmit"></button>
...
<script type="text/javascript">
    ...
    layui.use(['laydate','form','common','table'], function() {
        ...
        form.on('submit(updateLeaderInfoSubmit)', function(data){
            ...
            const office_id = parent.$("#office_id:hidden").val();
            const id = parent.$("#leader_id:hidden").val();
            ...
            $.ajax({
                type : 'POST',
                url : 'systemDataServlet?action=updateOfficeLeaderInfo',
                data : {
