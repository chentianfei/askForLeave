...
public interface AskForLeaveService {
    ...
    //按条件查询请假待审核信息_分页
    public List<HashMap<String,Object>> querySomeLeaveInfosLimit(Map<String, String[]> map,Integer pageNo,Integer pageSize) throws ParseException;
    ...
    //处理销假业务
    public int resumeWork(String serialnumberSTR, String end_leave_remarkSTR,String end_dateSTR,String end_leave_operator) throws ParseException;
