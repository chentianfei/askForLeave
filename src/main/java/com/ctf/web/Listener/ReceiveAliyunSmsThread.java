...
/**
 * @Description :
 * @ClassName ReceiveAliyunSmsThread
 * @Author tianfeichen
 * @Date 2022/6/19 21:01
 * @Version v1.0
 */
public class ReceiveAliyunSmsThread extends Thread {

    private static Log logger= LogFactory.getLog(ReceiveAliyunSmsThread.class);
    ...
    public void run() {
        ...
        // 此处需要替换成开发者自己的AK信息
        String accessKeyId="LTAIdXrYjYBMjsvk";
        String accessKeySecret="gagBAEHM1jBsjksCZwAjD36MQkag3L";
        ...
        String queueName="Alicom-Queue-1084226009586079-SmsUp";//在云通信页面开通相应业务消息后，就能在页面上获得对应的queueName，格式类似Alicom-Queue-******-SmsUp
        try {
